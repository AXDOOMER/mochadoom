...
//-----------------------------------------------------------------------------
//
// $Id: BufferedRenderer32.java,v 1.3 2012/11/06 16:07:00 velktron Exp $
//
...
class BufferedRenderer32 extends SoftwareParallelVideoRenderer<byte[], int[]> {
    ...
    void doWriteScreen() {
        ...
        try {
            ...
            Logger.getLogger(BufferedRenderer32.class.getName(), null).log(Level.SEVERE, e, null);
        }
    ...
    private class IntPaletteThread implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Logger.getLogger(BufferedRenderer32.class.getName(), null).log(Level.WARNING, e, null);
            }
        }
    }
}
