...
//  F_Finale.C
//
    public final static String E1TEXT = ("Once you beat the big badasses and\n"
    ...
    public final static String E3TEXT = ("The loathsome spiderdemon that\n"
    ...
    public final static String E4TEXT = ("the spider mastermind must have sent forth\n"
...
// after level 6, put this:
    public final static String C1TEXT = ("YOU HAVE ENTERED DEEPLY INTO THE INFESTED\n"
...
// After level 11, put this:
    public final static String C2TEXT = ("YOU HAVE WON! YOUR VICTORY HAS ENABLED\n"
...
// After level 20, put this:
    public final static String C3TEXT = ("YOU ARE AT THE CORRUPT HEART OF THE CITY,\n"
...
// Before level 31, put this:
    public final static String C5TEXT = ("CONGRATULATIONS, YOU'VE FOUND THE SECRET\n"
...
// after map 11
    public final static String P2TEXT = ("Even the deadly Arch-Vile labyrinth could\n"
...
// after map 20
    public final static String P3TEXT = ("You've bashed and battered your way into\n"
...
// after map 30
    public final static String P4TEXT = ("The Gatekeeper's evil face is splattered\n"
...
// before map 31
    public final static String P5TEXT = ("You've found the second-hardest level we\n"
            + "got. Hope you have a saved game a level or\n"
            + "two previous.  If not, be prepared to die\n"
            + "aplenty. For master marines only.");

// before map 32
    public final static String P6TEXT = ("Betcha wondered just what WAS the hardest\n"
            + "level we had ready for ya?  Now you know.\n"
            + "No one gets out alive.");

    public final static String T1TEXT = ("You've fought your way out of the infested\n"
    ...
    public final static String T2TEXT = ("You hear the grinding of heavy machinery\n"
    ...
    public final static String T3TEXT = ("The vista opening ahead looks real damn\n"
    ...
    public final static String T4TEXT = ("Suddenly, all is silent, from one horizon\n"
    ...
    public final static String T5TEXT = ("What now? Looks totally different. Kind\n"
            + "of like King Tut's condo. Well,\n"
            + "whatever's here can't be any worse\n"
            + "than usual. Can it?  Or maybe it's best\n"
            + "to let sleeping gods lie..");

    public final static String T6TEXT = ("Time for a vacation. You've burst the\n"
