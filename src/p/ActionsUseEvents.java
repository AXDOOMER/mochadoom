...
interface ActionsUseEvents extends ActionsPathTraverse {
    ...
    // USE LINES
    //
    @P_Map.C(PTR_UseTraverse) default boolean UseTraverse(intercept_t in) {
    ...
    public boolean DoPlat(line_t line, plattype_e plattype_e, int i);
}
