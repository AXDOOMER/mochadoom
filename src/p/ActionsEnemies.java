...
public interface ActionsEnemies extends ActionTrait {
    ContextKey<Enemies> KEY_ENEMIES = KEY_CHAIN.newKey(ActionsEnemies.class, Enemies.class);

    public boolean CheckSight(mobj_t actor, mobj_t target);
