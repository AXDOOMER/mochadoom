...
public interface ActionsSlideDoors extends ActionTrait {
    ...
    ContextKey<SlideDoors> KEY_SLIDEDOORS = KEY_CHAIN.newKey(ActionsSlideDoors.class, SlideDoors.class);
    ...
    default void EV_SlidingDoor(line_t line, mobj_t thing) {
        ...
        if (door == null) {
            ...
            if (door.whichDoorIndex < 0) {
                getDoomSystem().Error("EV_SlidingDoor: Can't use texture for sliding door!");
            }
