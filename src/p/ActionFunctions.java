...
public class ActionFunctions<T, V> {
	public ActionFunctions(DoomMain<T, V> DOOM){
	...
	ActionFunctions(DoomMain<T,V> DOOM, Enemies EN) {
		this(DOOM);
		this.EN=EN;
	}
    ...
    */}
    ...
    class A_BrainScream implements ActionType1{
        ...
        th.tics -= DOOM.random.P_Random()&7;
        if (th.tics < 1)
            th.tics = 1;
        }
