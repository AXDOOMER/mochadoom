...
public interface ActionsPlats extends ActionTrait {
    ContextKey<Plats> KEY_PLATS = KEY_CHAIN.newKey(ActionsPlats.class, Plats.class);
    
    int FindSectorFromLineTag(line_t line, int secnum);
    void RemoveThinker(plat_t activeplat);
    ...
    final class Plats {
        ...
        plat_t[] activeplats = new plat_t[data.Limits.MAXPLATS];
    }
