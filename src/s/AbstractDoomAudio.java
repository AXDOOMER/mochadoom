...
public class AbstractDoomAudio implements IDoomSound {
     ...
     */
    public void Init(int sfxVolume,
            int musicVolume) {
        int i;
    ...
    public void
            StartSoundAtVolume(ISoundOrigin origin_p,
                    int sfx_id,
                    int volume) {
    ...
    public void
            StartSound(ISoundOrigin origin,
                    sfxenum_t sfx_id) {
    ...
    //
    protected boolean
            AdjustSoundParams(mobj_t listener,
                    ISoundOrigin source,
                    vps_t vps) {
        int approx_dist;
        int adx;
